...
RcppExport SEXP _NZMastersample_log_b(SEXP xSEXP, SEXP baseSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _NZMastersample_HaltonSeq(SEXP kSEXP, SEXP baseSEXP, SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _NZMastersample_GetBoxIndices(SEXP lxySEXP, SEXP baseSEXP, SEXP JSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _NZMastersample_SolveCongruence(SEXP ASEXP, SEXP baseSEXP, SEXP JSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _NZMastersample_SolveCongruence2(SEXP ASEXP, SEXP baseSEXP, SEXP JSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix& >::type A(ASEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(SolveCongruence2(A, base, J));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_NZMastersample_log_b", (DL_FUNC) &_NZMastersample_log_b, 2},
    {"_NZMastersample_HaltonSeq", (DL_FUNC) &_NZMastersample_HaltonSeq, 3},
    {"_NZMastersample_GetBoxIndices", (DL_FUNC) &_NZMastersample_GetBoxIndices, 3},
    {"_NZMastersample_SolveCongruence", (DL_FUNC) &_NZMastersample_SolveCongruence, 3},
    {"_NZMastersample_SolveCongruence2", (DL_FUNC) &_NZMastersample_SolveCongruence2, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_NZMastersample(DllInfo *dll) {
